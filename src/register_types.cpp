...
{
	// Initialization.
	GDExtensionBool GDE_EXPORT gdduckdb_library_init(
		...
		) 
	{
		...
		init_obj.register_initializer(initialize_duckdb_module);
		init_obj.register_terminator(uninitialize_duckdb_module);
